// This snippet generates an ABP userid and inserts it into the page as if
// it came from AdBlock since Adblock Plus doesn't generate and insert a
// userid into relevant pages like AdBlock does.
(function(){
...
function getUserId() {
  ...
  return (page == "manage" || userid.length == 16) ? userid : "";
}
