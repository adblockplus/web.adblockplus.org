...
function onConfigLoad()
{
  ...
  stripeCard = ns.setupStripeCardModal({
  ...
  stripeCard.onError(form.showError);
}
...
{
  var brand = stripeCard.getBrand();

  if (
    brand != "unknown" 
    && stripeConfig.supportedCardBrands.indexOf(brand) == -1
  ) {
    return form.showError(i18n.error_card_brand);
  }
