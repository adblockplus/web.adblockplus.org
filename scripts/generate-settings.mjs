...
const VAT_COUNTRIES = ["AT","BE","BG","HR","CY","CZ","DK","EE","FI","FR","DE","GR","HU","IS","IE","IT","LV","LT","LU","MT","NL","NO","PL","PT","RO","SK","SI","ES","SE","CH","TR","GB"];

const UNIQUE_CURRENCIES = {"AU":"AUD","CA":"CAD","CH":"CHF","GB":"GBP","JP":"JPY","NZ":"NZD","RU":"RUB"};

const VAT_CURRENCIES = ["GBP","EUR","PLN","CHF"];
...
for (const country of ALL_COUNTRIES) {
  const defaultCurrency = UNIQUE_CURRENCIES[country] || (EUR_COUNTRIES.includes(country) ? "EUR" : DEFAULT_CURRENCY);
  const output = `(function(){
// GENERATED BY scripts/generate-settings.mjs. DO NOT MANUALLY EDIT.

adblock.settings.country = "${country == "ALL" ? "unknown" : country}";
adblock.settings.defaultCurrency = "${defaultCurrency}";
...
adblock.settings.VAT_COUNTRIES = ${JSON.stringify(VAT_COUNTRIES)};
adblock.settings.VAT_CURRENCIES = ${JSON.stringify(VAT_CURRENCIES)};
