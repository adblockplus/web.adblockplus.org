...
1. {{ disable-safari-step-1[list item] From the Safari toolbar, click the **Adblock Plus** icon and select **Open Adblock Plus**. }}
...
1. {{ disable-ios-safari-step-2 Tap the **Settings icon** at the bottom of the page. }}
1. {{ disable-ios-safari-step-3 From the Settings page, tap **Acceptable Ads**. }}
1. {{ disable-ios-safari-step-4 Toggle off **Allow some nonintrusive ads**. }}
...
1. {{ get-allowlisted-step-1[list item] If your website has ads that comply with the [Acceptable Ads standards](#criteria), simply fill out <a href="https://acceptableads.com/get-allowlisted/" title="{{ get-allowlisted-step-1-1[tooltip] Get Acceptable Ads Whitelisted }}">this form</a>. }}
