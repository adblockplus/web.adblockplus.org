...
1. {{ data-processed-item-1[list item] While using our products: extension or Adblock Browser (automatically, except for Issue Reporter) }}
    - {{ data-processed-item-2[list item] Extension updates, subscription downloads, emergency notifications: }}
      <div class="inline-list" markdown="1">
        ...
        - {{ data-processed-item-8[list item] For Issue Reporter submitted manually by you, additionally: address of the webpage with the bug, blockable items on the webpage, matching filters, active subscription (voluntary) }}
      </div>
...
{{ how-to-exercise-paragraph To exercise your rights, please contact us via [email](#privacy-email){: title="email address of Data Protection Officer at eyeo GmbH" } or mail to: }}
