...
{{ how-long-paragraph **Note**: “Aggregated usage statistics”, as analytics data, and other data without any connection to single users may be retained beyond these periods. }}
