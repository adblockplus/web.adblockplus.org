...
#### Base legal para coleta e processamento de dados {: #legal-basis }
...
Usamos ferramentas de provedores de serviços externos para e-mail (GSuite); para usuários não pertencentes à UE/EEE apenas para analisar seu uso dos nossos sites ([Google Analytics](#google-analytics)); para usuários fora da UE/EEE apenas para testes A/B com base nos dados analíticos ([Google Optimize](#google-optimize)) e para relatórios de falhas, eventos de interação anônimos e rastreamento de eventos em nossos produtos móveis e no Adblock Plus para Safari no macOS ([Firebase](https://firebase.google.com/)). Esses serviços são prestados pelo Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, EUA. A fim de garantir um nível adequado de proteção de dados, celebramos um acordo de processamento de dados, incluindo as Clausulas Contratuais Padrão da  UE  – Decisão da Comissão C(2010)593. Você pode acessar uma cópia deste acordo  [aqui](https://support.google.com/a/answer/2888485).

Usamos ferramentas de provedores de serviços externos para receber doações e analisar comportamentos fraudulentos em relação a doações. Este serviço é prestado pela Stripe, Inc., 510 Townsend Street, São Francisco, CA 94103, EUA. Alguns cookies são salvos em seu navegador antes de prosseguir com as transações de pagamento para evitar o uso fraudulento dos seus serviços. A Stripe coleta informações de identificação sobre os dispositivos que se conectam aos seus serviços e usa essas informações para detecção de fraudes. Para mais informações, [consulte a política de cookies da Stripe](https://stripe.com/cookies-policy/legal).

Também usamos ferramentas de provedores de serviços externos para suporte ao usuário. Estes serviços são prestados pela Zendesk, Inc., 1019 Market Street, São Francisco, CA 94103 (Zendesk) e pela Sprout Social, Inc., 131 S Dearborn Street, 7º andar Chicago, IL 60603 (Sprout). Firmamos acordos de processamento de dados com a Zendesk e a Sprout, incluindo as Cláusulas Contratuais Padrão (processadores) da UE  – Decisão da Comissão C(2010)593.
...
- Se já não precisarmos dos seus dados pessoais para as finalidades acima mencionadas.
...
#### Verificações de atualização de extensão {: #update-checks }
...
**Integração do Facebook Messenger** {: #facebook-messenger-integration }
...
##### Informações que você nos fornece voluntariamente {: #voluntary-info }
...
Caso você esteja celebrando um contrato de parceria, encontre aqui mais informações sobre nossos períodos de retenção: [https://eyeo.com/privacy/#privacy_information_business_partner](https://eyeo.com/privacy/#privacy_information_business_partner).
...
- **Twitter** (Twitter Inc., 1355 Market Street, Suite 900, San Francisco, CA 94103, EUA) – Política de Privacidade: [https://twitter.com](https://twitter.com), Opt-Out: [https://twitter.com/personalization](https://twitter.com/personalization)
...
#### Quais são seus direitos sob a CCPA?
