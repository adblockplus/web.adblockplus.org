...
* Whalebone stores DNS request data for up to 48 hours. DNS requests originating from the EU are stored in compliance with GDPR requirements. Adblock Plus may access data stored by Whalebone to conduct aggregate analysis for debugging and product improvement purposes, and to provide you with device-specific statistics about the app's blocking effectiveness.
